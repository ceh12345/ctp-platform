...
*Last updated: June 20, 2026 (Engine — Pred/Succ Edge-List Refactor landed: Phases 0-3, suite 1219/10 byte-identical, UI-verified on acme-outpatient + stafford-slim-100; moved Up Next → Done)*
