...
*Last updated: June 21, 2026 (Engine — Accurate Infeasibility Reporting landed: detection-time binding-task attribution + horizon/dependency classification + Conflicts-page Horizon chip; 7-tenant verified, suite 1219/10)*
